...
public class CreateCafe
{
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        ...
        RenderTypeLookup.setRenderLayer(ModFluids.MANGO_TEA.get(), RenderType.getTranslucent());

        RenderTypeLookup.setRenderLayer(ModBlocks.COFFEE.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.CASSAVA.get(), RenderType.getCutout());
    }
